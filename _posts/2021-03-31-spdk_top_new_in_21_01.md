...
![Bottom menu]({{ site.baseurl }}/assets/img/blog/spdk_top/spdk_top_bottom_menu.png)
...
![Threads tab]({{ site.baseurl }}/assets/img/blog/spdk_top/spdk_top_threads_tab.png)

![Threads pop-up details window]({{ site.baseurl }}/assets/img/blog/spdk_top/spdk_top_threads_pop_up.png)

And here's what it looks like on the pollers tab:

![Pollers tab]({{ site.baseurl }}/assets/img/blog/spdk_top/spdk_top_pollers_tab.png)

![Pollers pop-up details window]({{ site.baseurl }}/assets/img/blog/spdk_top/spdk_top_pollers_pop_up.png)

Finally, the cores tab:

![Cores tab]({{ site.baseurl }}/assets/img/blog/spdk_top/spdk_top_cores_tab.png)

![Cores pop-up details window]({{ site.baseurl }}/assets/img/blog/spdk_top/spdk_top_cores_pop_up.png)
