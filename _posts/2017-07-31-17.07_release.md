...
See the [vhost documentation](https://www.spdk.io/doc/vhost.html) for more details.
...
See the [GPT bdev documentation](https://www.spdk.io/doc/bdev.md#bdev_config_gpt) for
more information.
