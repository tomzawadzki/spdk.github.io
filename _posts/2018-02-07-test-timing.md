...
![CI Link]({{ site.baseurl }}/assets/img/blog/test-timing/plus_1.png "CI Link")
...
![Test System Link]({{ site.baseurl }}/assets/img/blog/test-timing/test_system.png "Test System Link")

In the directory listing, you'll see the file `timing.svg`; click on it.

![Directory Listing]({{ site.baseurl }}/assets/img/blog/test-timing/dir_list.png "Directory Listing")
...
![Timing]({{ site.baseurl }}/assets/img/blog/test-timing/timing.png "Timing")
