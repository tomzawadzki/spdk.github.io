...
![4KiB Performance]({{ site.baseurl }}/assets/img/blog/big_numbers_4k.png "Over 9000!")
<br/>
...
![512B Performance]({{ site.baseurl }}/assets/img/blog/big_numbers.png "Over 9000!")
<br/>
...
> If the driver were to
> perform an MMIO on each command submission and on each command completion, it
> would be capped to less than 4 million I/O per second on most platforms.
...
> The goal is to have the right things in the
...
![Structure Packing]({{ site.baseurl }}/assets/img/blog/pahole.png "pahole is best named tool in the history of tools")
